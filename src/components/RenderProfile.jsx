  ...
  return (
    <TouchableWithoutFeedback onPress={handleClose}>
      ...
      <View style={tw`bg-[${COLORS.primary}] flex-1`}>
        {/* <ScrollView> */}
        {/*Keeping the Scrollview arises an error in Flatlist , So removed the Scrollview making only the posts scrollable, keeping the profile information at place.
        */}
